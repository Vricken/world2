...
Add the node from `res://modules/addons/extremely_fast_atmosphere/atmosphere/atmosphere.tscn` into your scene, and adjust the planet radius and atmosphere height properties.
