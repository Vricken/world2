...
- Main scene atmosphere tuning in `scenes/main.tscn`, including a thinner default `atmosphere_height = 350.0`, reduced shell density, and baked twilight/height profiles tuned toward a more Earth-like sky without adding raymarching.
